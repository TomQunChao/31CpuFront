...
-- Command     : write_vhdl -force -mode funcsim -rename_top iram -prefix
--               iram_ iram_sim_netlist.vhdl
-- Design      : iram
...
architecture STRUCTURE of iram_rom is
...
begin
\gen_rom.rom_inst\: entity work.iram_rom
     port map (
